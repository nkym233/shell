...
sleep 1
wget -O /usr/local/etc/v2ray/config.json --no-check-certificate https://git.wej.cc/https://github.com/nkym233/shell/blob/27ec0e8c6f4f98763328cc8fc8d40a2beca2cb5c/config.json
sleep 1
